...
- **[OrkasVideoStudio](https://github.com/Orkas-AI/Orkas-VideoStudio)** - Local-first TypeScript CLI and MCP toolkit for composing, editing, generating, transcribing, and assembling videos from editable `plan.json` timelines.
